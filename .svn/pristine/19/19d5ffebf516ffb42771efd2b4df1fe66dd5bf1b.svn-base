...
<html>
  ...
  <body>
   	<form name="myform" action="toModUserAction.action?user.accountId=<s:property value="#user.accountId" />" method="post" enctype="multipart/form-data" onsubmit="return validateAll()">
   		<table  cellpadding="0" cellspacing="0" width="90%">
   			<caption><font color="green" size="5px"><b>用户信息修改</b></font></caption>
   			<tr >
   				<td colspan="3" rowspan="4" align="center">
   					<div id="divPreview" >
		    			<img id="imgHeadPhoto" style="width: 160px; height: 170px;" alt="no" src="<%=path %>/upload/<s:property value="#user.photo" />" />
		    		</div>
   				</td>
   				<td width="150px">账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
   				<td width="200px"><input value="<s:property  value="#user.account"/>" name="user.account" id="account" type="text" onfocus="accountFocus();" onblur="accountBlur();" disabled="disabled"></td>
   				<td width="250px" id="accountId">&nbsp;</td>
   			</tr>
 			<tr>
   				<td>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
   				<td><input value="<s:property  value="#user.userName"/>" name="user.userName" id="userName" type="text" onfocus="userNameFocus();" onblur="userNameBlur();"></td>
   				<td id="userNameId">&nbsp;</td>
   			</tr>
   			<tr>
   				<td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
   				<td><input value="<s:property  value="#user.password"/>" name="user.password" id="password" type="password" onfocus="pswFocus();" onblur="pswBlur();" ></td>
   				<td id="passwordId">&nbsp;</td>
   			</tr>
   			<tr>
   				<td>确认密码：</td>
   				<td><input value="<s:property  value="#user.password"/>" id="password1" type="password" onfocus="pswQFocus();" onblur="pswQBlur();"></td>
   			...
   			<tr>
   				...
   				<td>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
   				<td>
   					<s:radio list="#{'1':'男','2':'女'}" name="user.sex" value="%{#user.sex}"></s:radio>
   				</td>
   				<td>&nbsp;</td>
   			</tr>
   			<tr>
   				<td >访问页面：</td>
   				<td colspan="2" width="170px"><input type="text" value="<s:property  value="#user.homePage"/>" name="user.homePage" /></td>
   				<td >邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</td>
   				<td><input value="<s:property  value="#user.email"/>" name="user.email" id="mail" type="text" onfocus="mailFocus();" onBlur="mailBlur();"></td>
   				<td id="mailId">&nbsp;</td>
   			</tr>
   			<tr>
   				<td>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务：</td>
   				<td colspan="2"><input value="<s:property  value="#user.position"/>" name="user.position" id="position" type="text"></td>
   				<td>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
   				<td><input value="<s:property  value="#user.telphone"/>" name="user.telphone" id="telphone" type="text" onfocus="telFocus();" onblur="telBlur();"></td>
   				<td id="telphoneId">&nbsp;</td>
   			</tr>
   			<tr>
   				<td>部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门：</td>
   				<td colspan="2">
   					<s:select value="%{#user.org.org_id}" list="#orgList" listKey="org_id" listValue="org_name" name="org_id" id="org"></s:select>  				
   				</td>
   				<td width="100px">身份证号：</td>
    			<td width="150px"><input type="text" value="<s:property value="#user.identity"/>" name="user.identity" id="identity" onfocus="idenFocus();" onblur="idenBlur();" ></td>
   				<td id="identityId">&nbsp;</td>
   			</tr>
   	   </table>
   	   <br/>
