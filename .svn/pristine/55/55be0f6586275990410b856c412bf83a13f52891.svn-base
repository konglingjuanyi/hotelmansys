...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function toJSONAjax(){
  			...
  			//JSON不能使用模型驱动
  			//解决办法
  			var params = "productType.type_name="+productType_name;
  			$.ajax({
  				type:"post",
  				url :"addProductTypeJsonAjaxAction.action",
  				data:params,
  				dataType:"json",
  ...
  <body>
    <form action="toAddProductTypeAction.action" method="post" onsubmit="return validate()">
    	<center>
	    	<table cellpadding="0" cellspacing="0" width="90%">
	    		...
	    		<tbody>
	    			<tr>
	    				<td>类型名称:</td>
	    				<td><input type="text" name="productType.type_name" id="productType_name" onblur="validate()" /></td>
