...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function toJSONAjax(){
  			...
  			//JSON不能使用模型驱动
  			//解决办法
  			var params = "consumer.consu_name="+consu_name;
  			$.ajax({
  				type:"post",
  				url :"addconsuJsonJsonAjaxAction.action",
  				data:params,
  				dataType:"json",
  ...
  <body>
    <form action="toAddConsumerAction.action" method="post" name="consuForm" onsubmit="return validate()">
    	<center>
	    	<table cellpadding="0" cellspacing="0" width="90%">
	    		<thead>
	    			<tr align="center">
	    				<td colspan="3"><font color="green" size="4px"><b>添加 顾客</b></font></td>
	    			</tr>
	    		</thead>
	    		<tbody>
	    			<tr>
	    				<td>顾客姓名:</td>
	    				<td><input type="text" name="consumer.consu_name" id="consu_name" onblur="nameBlur()" /></td>
	    				<td width="150px" id="consu_name_id">&nbsp;</td>
	    			</tr>
	    			<tr>
	    				<td>电话:</td>
	    				<td><input type="text" name="consumer.consu_telphone" id="consu_telphone" onblur="telphoneBlur()" /></td>
	    				<td width="150px" id="consu_telphone_id">&nbsp;</td>
	    			</tr>
	    			<tr>
	    				<td>身份证:</td>
	    				<td><input type="text" name="consumer.consu_identify" id="consu_identify" onblur="identifyBlur()" /></td>
	    				<td width="150px" id="consu_identify_id">&nbsp;</td>
	    			</tr>
	    			<tr>
	    				<td>会员卡</td>
	    				<td colspan="2">
   							<s:select list="#vipList" listKey="vip_id" listValue="vip_name" name="vip_id" id="vip"></s:select>  				
   						</td>
	    			</tr>
	    			<tr>
	    				<td>会员留言:</td>
	    				<td colspan="2">
	    					<textarea cols="35" rows="3" name="consumer.consu_say"></textarea>
	    				</td>
	    			</tr>
	    		</tbody>
	    	</table>
