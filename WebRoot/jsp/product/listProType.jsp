   ...
   <head>
		...
		<script type="text/javascript">
			...
			function toWindow(type,type_id){
				...
				switch(type){
					case 'mod':
						art.dialog.open('modProductTypeProductTypeAction.action?productType.type_id='+type_id, {
							id: 'type_mod_win',
							title: '修改商品类型界面',
							width:500,
							height:300,
						...
						case 'add':
							art.dialog.open('addProductTypeProductTypeAction.action', {
								id: 'type_add_win',
								title: '添加类型界面',
								width:500,
								height:300,
						...
						case 'del':
							...
							if(result==true){
								art.dialog.open('delProductTypeProductTypeAction.action?productType.type_id='+type_id, {
										id: 'type_del_win',
										title: '删除类型界面',
										width:500,
										height:300,
	...
	<body>
		...
		<div class="div_bk">
			...
			<table id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					<td width="130"><h1>商品类型管理</h1></td>
				</tr>
			</table>
			<!-- 搜索区 -->
			<form action="listProTypeProductTypeAction.action" method="post" name="productTypeQueryForm">
				<table class="maintable">
	   				<tr>
	   					<th>客房类型名称</th>
	   					<td colspan="3" ><input type="text" class="text" name="query.ptName" value="<s:property value="query.ptName" />" /></td>
	   				</tr>
	   				<tr align="center">
   			...
   			<table class="listtable stripe">
   				...
   				<s:iterator value="productTypeList" var="type" status="st">
   					<tr>
