...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function toJSONAjax(){
  			...
  			var org_id = '<s:property value="%{#org.org_id}" />';
  			//JSON不能使用模型驱动
  			//解决办法
  			var params = "name="+name+"&org.org_id="+org_id;
  			$.ajax({
  				type:"post",
  				url :"orgJsonModJsonAjaxAction.action",
  				data:params,
  				dataType:"json",
  ...
  <body>
    <form action="toModOrgAction.action?org.org_id=<s:property value="#org.org_id" />" method="post" onsubmit="return nameBlur()">
    	<center>
	    	<table cellpadding="0" cellspacing="0" width="90%">
	    		<thead>
	    			<tr align="center">
	    				<td colspan="3"><font color="green" size="4px"><b>部门修改</b></font></td>
	    			</tr>
	    		</thead>
	    		<tbody>
	    			<tr>
	    				<td>部门名称:</td>
	    				<td><input value=<s:property value="#org.org_name" /> type="text" name="org.org_name" id="org_name" onfocus="nameFocus()" onblur="nameBlur()" /></td>
	    				<td width="150px" id="org_name_id">&nbsp;</td>
	    			</tr>
	    			<tr>
	    				<td>部门描述:</td>
	    				<td colspan="2"><textarea cols="30" rows="5" name="org.org_desc"><s:property value="#org.org_desc" /></textarea></td>
	    			</tr>
	    		</tbody>
	    	</table>
	    	<br /><br />
