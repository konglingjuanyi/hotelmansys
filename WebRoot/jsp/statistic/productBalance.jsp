...
<html>
    ...
    <script type="text/javascript" src="<%=path %>/resource/common/jquery-1.8.3.js"></script>
 	...
 	<script type="text/javascript">
 		function showCharts(){
 			...
 			//声明FunsionChar对象
 			var chart2D_1 = new FusionCharts("FunsionChar/swf/Pie2D.swf", "myfist", "480", "380");
			//chart.setDataURL(escape("column3DChart!initColumn3D.action"));
			$.ajax( {
				url : 'showProductFunsionChartAction.action?year='+year,
				type : 'post',
				dataType : 'text',
				async : false,
				error : function() {
 		...
 		function showCharts1(){
 			...
 			//声明FunsionChar对象
 			var chart2D_2 = new FusionCharts("FunsionChar/swf/Pie2D.swf", "myfist", "480", "380");
			//chart.setDataURL(escape("column3DChart!initColumn3D.action"));
			$.ajax( {
				url : 'showProduct1FunsionChartAction.action?year='+year,
				type : 'post',
				dataType : 'text',
				async : false,
				error : function() {
  ...
  <body>
  	请选择年份：
    <select id="year" onchange="showCharts(),showCharts1();">
		...
		<font color="blue" size="3px"><b>(1)2D饼状图</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<font color="blue" size="3px"><b>(2)2D饼状利润图</b></font>
		<div>
