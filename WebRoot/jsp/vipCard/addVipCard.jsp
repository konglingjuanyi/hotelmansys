...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function toJSONAjax(){
  			...
  			//JSON不能使用模型驱动
  			//解决办法
  			var params = "vipCard.vip_name="+vip_name;
  			$.ajax({
  				type:"post",
  				url :"addVipCardJsonJsonAjaxAction.action",
  				data:params,
  				dataType:"json",
  ...
  <body>
    <form action="toAddVipCardAction.action" method="post" onsubmit="return validate()">
    	<center>
	    	<table cellpadding="0" cellspacing="0" width="90%">
	    		<thead>
	    			<tr align="center">
	    				<td colspan="3"><font color="green" size="4px"><b>添加会员卡</b></font></td>
	    			</tr>
	    		</thead>
	    		<tbody>
	    			<tr>
	    				<td>会员卡名称:</td>
	    				<td><input type="text" name="vipCard.vip_name" id="vip_name" onblur="nameBlur()" /></td>
	    				<td width="150px" id="vip_name_id">&nbsp;</td>
	    			</tr>
	    			<tr>
	    				<td>会员卡折扣率:</td>
	    				<td><input type="text" name="vipCard.vip_discount" id="vip_discount" onblur="discountBlur()" /></td>
